...
### 1.1 Agent란 무엇인가 (Model, Instructions, Tools) 🧩

#### 1.1.1 우리가 떠올리는 Agent의 이미지 🎬
...
## 2. Agent에게 규칙(Instruction)을 부여하는 방법 ✍️  
### – 개발 Prompt 작성하는 방법
...
### 2.1 Instruction을 WHY / HOW / WHAT으로 나누기 📑
...
## 3. Agent의 System Prompt 톺아보기 🔍  
### – Context 힌트 알아보기

#### 3.1 왜 System Prompt를 봐야 하는가?
...
#### 4.3 MCP(Model Context Protocol)의 의미 🔌
...
## 6. Model 선택도 Instruction의 일부 ⚙️

#### 6.1 “당신은 Claude Sonnet 4로 구동되는 AI 코딩 어시스턴트입니다”  
...
### 8.1 내가 일하는 방식을 분해하자 (Workflow 구성하기) 🔨
...
### 8.3 내가 일하는 방식대로 Workflow 구성하기 실습 🧑‍💻
...
### 8.4 Rules로 Agent에게 명확히 지시하기 실습 (Instruction) ✍️
...
## 9. Agent가 활용 가능한 Tool 설정하기 실습 (MCP Server) 🔌
...
## 10. 나만의 Mode로 상황에 맞는 Model 설정하기 (Custom Mode) 🎛️
...
## 11. MCP Server를 활용하여 Task별로 개발하기 📂
...
## 14. Cursor 고급 기법을 활용한 FrontEnd 개발 실습 🎨
...
## 21. Code Rabbit을 통한 Code Review 환경 구성하기 🐇
...
### 23.1 보안이 강화된 환경에서 오픈소스 Coding Tool의 활용 🔐
...
### 16.1 개인의 활용과 조직에서의 활용은 무엇이 다를까 ⚖️
...
## 20. 표준 Workflow를 통한 MCP Server 관리하기 🔐
...
## 24. Cline을 통한 Agent Coding 환경 구성하기 🖥️
...
#### 24.3 Cline에서의 Agent Workflow 예시 🔄
...
## 26. Ollama를 활용한 자체 Model 설정하기 🖥️

#### 26.1 왜 자체 Model이 필요한가?
...
#### 26.3 Ollama 기반 AI Coding 구조 예시 🧩
...
이 장에서는 단순히 AI를 사용하는 수준을 넘어,  
**Agent 기반으로 업무를 구조화하고 조직에 편입시키는 방법** 을 다루었습니다.  

- Agent의 본질은 **목표 달성 시스템**  
- Instruction, Rules, Workflow, MCP, Memory가 핵심 요소  
- Cursor는 IDE를 넘어 **Agent 플랫폼**  
- 조직에서는 AI를 **구성원** 으로 다뤄야 한다  
- 보안 환경에서는 오픈소스와 자체 모델(Ollama)도 전략적 대안이 된다  

👉 다음 단계에서는 이 모든 개념을 실제 프로젝트에 적용해,  
**AI와 함께 일하는 개발자의 새로운 패러다임** 을 체험하게 됩니다.